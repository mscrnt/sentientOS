...
pub fn create_command_arg_schema() -> crate::Schema {
    use crate::schema::{SchemaBuilder, FieldType};
...
pub fn create_ai_prompt_schema() -> crate::Schema {
    use crate::schema::{SchemaBuilder, FieldType};
    use crate::constraints::*;
