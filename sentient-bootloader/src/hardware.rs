...
use crate::boot_info::{HardwareInfo, CpuFeatures, GpuDevice};
...
pub fn detect_hardware(boot_services: &BootServices) -> HardwareInfo {
    ...
    serial_println!("  ✓ CPU: {} ({} cores, {} threads)", cpu_vendor, cpu_features.cores, cpu_features.threads);
    serial_println!("  ✓ Features: AVX2={}, AVX512={}, AMX={}", 
        cpu_features.avx2, cpu_features.avx512, cpu_features.amx);
